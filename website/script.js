...
function submitForm(formData) {
  ...
  fetch('https://bhqdygm5f3.execute-api.us-east-1.amazonaws.com/dev', { // URL that represents the backend API endpoint to which the form data is going to be sent
    method: 'POST',
    headers: {
